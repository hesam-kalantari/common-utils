...
package com.khesam.common.delete;
...
class DateConverter {
  ...
  public static void main(String[] args) {
    int[] shamsi = gregorian_to_jalali(1992, 6, 25);
    System.out.println(shamsi[0]+"/"+shamsi[1]+"/"+shamsi[2]);

//    int[] miladi = jalali_to_gregorian(1399,4,21);
//    System.out.println(miladi[0]+"/"+miladi[1]+"/"+miladi[2]);
  }
